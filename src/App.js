...
const COMMERCIALES = [
  ...
  { nom: "AMI DOUMBIA",      pass: "DOUDJAME15" },
  { nom: "KOUDOU MARLENE",     pass: "KOUDJAME16" },
];
const ADMINS = [
...
const PRODUITS_PRIX = {
  ...
  "Silver Care PROTECTION CONTINUE": 2200,
            ...
            {submitted ? (
              ...
              <div>
                <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
                  <button onClick={() => setSansVenteMode(false)} style={{ flex: 1, padding: "10px", borderRadius: 10, border: "none", background: !sansVenteMode ? "#2b6cb0" : "white", color: !sansVenteMode ? "white" : "#4a5568", fontWeight: 800, fontSize: 13, cursor: "pointer" }}>
                    Rapport avec ventes
                  </button>
                  <button onClick={() => setSansVenteMode(true)} style={{ flex: 1, padding: "10px", borderRadius: 10, border: "none", background: sansVenteMode ? "#744210" : "white", color: sansVenteMode ? "white" : "#4a5568", fontWeight: 800, fontSize: 13, cursor: "pointer" }}>
                    Journee sans vente
                  </button>
                </div>
                {sansVenteMode ? (
                  <div style={{ background: "white", borderRadius: 18, boxShadow: "0 4px 20px rgba(0,0,0,0.08)", padding: 28 }}>
                    ...
                    <div style={{ fontSize: 13, color: "#718096", marginBottom: 20 }}>Signalez une journee sans vente avec un commentaire</div>
...
function ComptabiliteAdmin() {
  ...
  const PRODUITS_LISTE = [
    ...
    "L'Acrose Face cleasing gel 250 ml",
    "L'Acrose Magic White cream 45",
    "L'Acrose savon extrait de riz",
    "L'Acrose Tea tree oil shower gel 400",
    "L'Acrose Vitamines C Sérum",
    "L'Acrose White pearl soap",
    "L'Acrose whitening body milk 500 ml",
    "L'Acrose Whitening serum30 ml",
    "L'Acrose creme LIFTANTE",
    "L'Acrose brume corporelle",
    "L'Acrose gel de douche au jasmin",
    "L'Acrose gel de douche À L'huile De Pépins De Grenade",
    "L'Acrose Hyaluronic serum",
    "L'Acrose collagene serum",
    "L'Acrose creme blanchissante (whitening cream)",
    "Silver Care BDB Chlorhexidine 0,20%",
    "SILVER CARE BROSSE ONE CARBON",
    "SILVER CARE PATE SENSITIVE",
    "SILVER CARE PATE WHITENING",
    "Helan Agrume latte nutriente lait",
    "Helan Agrume parfum",
    "Helan Crème solaire",
    "Helan Day DD cream",
    "Helan Di talco lait hydratant",
    "Helan Di talco Parfum",
    "Helan Eau micellaire",
    "Helan linea Bimba pan savon",
    "Helan linea Bimbi Acqua luigia eau de toilette",
    "Helan linea Bimbi Bagno fetal gel lavant 250 ml",
    "Helan linea Bimbi gel lavant 500 ml",
    "Helan linea Bimbi Natural cleansing lingette",
    "Helan linea Bimbi Pâte protectrice",
    "Helan linea Bimbi Silky liquid talk lait",
    "Helan linea Bimbi Dolcezza lait démaquillant",
    "Piave brosse Dentonet 6/24",
    "Piave brosse White & Dunn",
    "Piave four fruits brosse JR 3+",
    "Piave four fruits kit (Pâte & brosse)",
    "Piave oxigen brosse hard",
    "Piave oxigen brosse medium",
    "Piave oxigen brosse soft",
    "Silver Care bain de bouche 250 ml",
    "Silver Care bain de bouche 500 ml",
    "Silver Care BDB Chlorhexidine 0,12%",
    "Silver Care brosse H2O Orthodontic",
    "Silver Care Brosse happy 6/36 mois",
    "Silver Care Brosse kid 2/6 ans",
    "Silver Care brosse ONE Sensitive",
    "Silver Care brosse ONE Whitening",
    "Silver Care Brosse teen 7/12 ans",
    "Silver Care brossette fin",
    "Silver Care brossette extra fin",
    "Silver Care brossettemedium",
    "Silver Care brossette large",
    "Silver Care Fil dentaire",
    "Silver Care kit (Brosse & Pâte)",
  ...
  const updateLigne = (i, field, val) => setForm(f => ({
    ...f,
    lignes: f.lignes.map((l, idx) => {
      if (idx !== i) return l;
      const updated = { ...l, [field]: val };
      if (field === "produit" && PRIX_DEFAUT[val] !== undefined) {
        updated.prixUnitaire = String(PRIX_DEFAUT[val]);
      }
      return updated;
    })
  }));
